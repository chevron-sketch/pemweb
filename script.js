// Mobile menu
  ...
  // Testimonial rotator
  const testimonials = [
    {quote:"\"Dulu nilai Matematika saya selalu di bawah rata-rata. Setelah tiga bulan pakai Cerlang, saya akhirnya paham logika di balik rumus, bukan cuma hafal.\"", who:"— RAFI A., KELAS 9, SMP Negeri 1 Pekanbaru"},
    {quote:"\"Rangkuman otomatisnya sangat membantu pas mau ujian. Saya nggak perlu nulis ulang catatan dari video.\"", who:"— DINA P., KELAS 11, SMA Negeri 1 SURABAYA"},
    {quote:"\"Forum tanya jawabnya cepat dibalas pengajar asli, bukan cuma jawaban template.\"", who:"— BIMA S., KELAS 10, SMA Negeri 1 MEDAN"},
  ];
